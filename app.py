...
st.subheader("Check all symptoms that apply. Leaving unchecked means you do not have the symptom. N.B: Leaving all boxes unchecked will lead to no disease.")
